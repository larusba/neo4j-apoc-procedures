...
[cols="1m,5"]
|===
| apoc.meta.v2.type(value) | type name of a value (`INTEGER,FLOAT,STRING,BOOLEAN,RELATIONSHIP,NODE,PATH,NULL,MAP,LIST,POINT,DATE,DATE_TIME,LOCAL_TIME,LOCAL_DATE_TIME,TIME,DURATION`)
| apoc.meta.v2.isType(value,type) | returns a row if type name matches none if not
| apoc.meta.v2.types(node or relationship or map) | returns a a map of property-keys to their names
|===
