...
| apoc.coll.sortNodes([nodes], 'name') | sort nodes by property, reverse sorting by adding ^ in front of the sorting field
| apoc.coll.sortMaps([maps], 'key') | sort maps by map key, reverse sorting by adding ^ in front of the sorting field
